...
public class SwaggerConfig {
    ...
    public OpenAPI ordersOpenAPI() {
        return new OpenAPI()
                ...
                .addSecurityItem(new SecurityRequirement().addList("oauth2Client"))
                .addSecurityItem(new SecurityRequirement().addList("oauth2User"))
                .components(new Components()
                        .addSecuritySchemes("bearer", new SecurityScheme()
                                .type(SecurityScheme.Type.HTTP)
                                .scheme("bearer")
                                .bearerFormat("JWT"))
                        .addSecuritySchemes("oauth2Client", new SecurityScheme()
                                .type(SecurityScheme.Type.OAUTH2)
                                .description("Machine / service token (client credentials)")
                        ...
                        .addSecuritySchemes("oauth2User", new SecurityScheme()
                                .type(SecurityScheme.Type.OAUTH2)
                                .description("Interactive login (authorization code + PKCE)")
                                .flows(new OAuthFlows()
